    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_before_discount', models.DecimalField(decimal_places=2, default=0.0, max_digits=100)),
                ('grand_total', models.DecimalField(decimal_places=2, default=0.0, max_digits=100)),
                ('you_save', models.DecimalField(decimal_places=2, default=0.0, max_digits=100)),
